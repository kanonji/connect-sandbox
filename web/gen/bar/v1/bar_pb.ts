...
// @generated from file bar/v1/bar.proto (package bar.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message bar.v1.InvokeResponse
 */
export class InvokeResponse extends Message<InvokeResponse> {
  ...
  static readonly typeName = "bar.v1.InvokeResponse";
...
/**
 * @generated from message bar.v1.GetRequest
 */
export class GetRequest extends Message<GetRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bar.v1.GetRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
...
/**
 * @generated from message bar.v1.GetResponse
 */
export class GetResponse extends Message<GetResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "bar.v1.GetResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 5 /* ScalarType.INT32 */ },
