...
const (
	...
	BazServiceName = "protobuf_foo.baz.v1.BazService"
)

// BazServiceClient is a client for the protobuf_foo.baz.v1.BazService service.
...
// NewBazServiceClient constructs a client for the protobuf_foo.baz.v1.BazService service. By
...
func NewBazServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) BazServiceClient {
	...
	return &bazServiceClient{
		do: connect_go.NewClient[emptypb.Empty, v1.DoResponse](
			httpClient,
			baseURL+"/protobuf_foo.baz.v1.BazService/Do",
			opts...,
		),
	}
}
...
// Do calls protobuf_foo.baz.v1.BazService.Do.
...
// BazServiceHandler is an implementation of the protobuf_foo.baz.v1.BazService service.
...
func NewBazServiceHandler(svc BazServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/protobuf_foo.baz.v1.BazService/Do", connect_go.NewUnaryHandler(
		"/protobuf_foo.baz.v1.BazService/Do",
		svc.Do,
		opts...,
	))
	return "/protobuf_foo.baz.v1.BazService/", mux
}
...
func (UnimplementedBazServiceHandler) Do(context.Context, *connect_go.Request[emptypb.Empty]) (*connect_go.Response[v1.DoResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("protobuf_foo.baz.v1.BazService.Do is not implemented"))
}
