...
const (
	...
	BazServiceName = "protobuf.baz.v1.BazService"
)

// BazServiceClient is a client for the protobuf.baz.v1.BazService service.
...
// NewBazServiceClient constructs a client for the protobuf.baz.v1.BazService service. By default,
...
func NewBazServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) BazServiceClient {
	...
	return &bazServiceClient{
		do: connect_go.NewClient[emptypb.Empty, v1.DoResponse](
			httpClient,
			baseURL+"/protobuf.baz.v1.BazService/Do",
			opts...,
		),
	}
}
...
// Do calls protobuf.baz.v1.BazService.Do.
...
// BazServiceHandler is an implementation of the protobuf.baz.v1.BazService service.
...
func NewBazServiceHandler(svc BazServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/protobuf.baz.v1.BazService/Do", connect_go.NewUnaryHandler(
		"/protobuf.baz.v1.BazService/Do",
		svc.Do,
		opts...,
	))
	return "/protobuf.baz.v1.BazService/", mux
}
...
func (UnimplementedBazServiceHandler) Do(context.Context, *connect_go.Request[emptypb.Empty]) (*connect_go.Response[v1.DoResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("protobuf.baz.v1.BazService.Do is not implemented"))
}
