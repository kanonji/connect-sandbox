...
const (
	...
	BarServiceName = "protobuf.bar.v1.BarService"
)

// BarServiceClient is a client for the protobuf.bar.v1.BarService service.
...
// NewBarServiceClient constructs a client for the protobuf.bar.v1.BarService service. By default,
...
func NewBarServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) BarServiceClient {
	...
	return &barServiceClient{
		invoke: connect_go.NewClient[emptypb.Empty, v1.InvokeResponse](
			httpClient,
			baseURL+"/protobuf.bar.v1.BarService/Invoke",
			opts...,
		),
		get: connect_go.NewClient[v1.GetRequest, v1.GetResponse](
			httpClient,
			baseURL+"/protobuf.bar.v1.BarService/Get",
			opts...,
		),
	}
}
...
// Invoke calls protobuf.bar.v1.BarService.Invoke.
...
// Get calls protobuf.bar.v1.BarService.Get.
...
// BarServiceHandler is an implementation of the protobuf.bar.v1.BarService service.
...
func NewBarServiceHandler(svc BarServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	mux.Handle("/protobuf.bar.v1.BarService/Invoke", connect_go.NewUnaryHandler(
		"/protobuf.bar.v1.BarService/Invoke",
		svc.Invoke,
		opts...,
	))
	mux.Handle("/protobuf.bar.v1.BarService/Get", connect_go.NewUnaryHandler(
		"/protobuf.bar.v1.BarService/Get",
		svc.Get,
		opts...,
	))
	return "/protobuf.bar.v1.BarService/", mux
}
...
func (UnimplementedBarServiceHandler) Invoke(context.Context, *connect_go.Request[emptypb.Empty]) (*connect_go.Response[v1.InvokeResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("protobuf.bar.v1.BarService.Invoke is not implemented"))
}
...
func (UnimplementedBarServiceHandler) Get(context.Context, *connect_go.Request[v1.GetRequest]) (*connect_go.Response[v1.GetResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("protobuf.bar.v1.BarService.Get is not implemented"))
}
